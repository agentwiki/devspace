...
> surviving controllers on a rolling deploy instead of destroying it. M16
...
> announcement survive the release. M19 makes that release reversible: a
...
> with the same policy, and refused wherever it cannot be enforced. M23
> adds the widening half under an operator ceiling: `SANDBOX_TENANT_HOSTS`
